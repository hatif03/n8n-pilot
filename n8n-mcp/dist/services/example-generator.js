...
return results;`
     ...
     */
    static getMinimalExample(nodeType) {
     ...
     */
    static getCommonExample(nodeType) {
        const examples = this.getExamples(nodeType);
     ...
     */
    static getAdvancedExample(nodeType) {
        const examples = this.getExamples(nodeType);
     ...
     */
    static getAllExamples(nodeType) {
        const examples = this.getExamples(nodeType);
        if (!examples)
            return null;
        return {
     ...
     */
    static getBulkExamples(nodeTypes) {
        const results = {};
     ...
     */
    static validateConfiguration(nodeType, config) {
        const examples = this.getExamples(nodeType);
        if (!examples) {
            return {
                isValid: false,

...
export const addConnectionTool = {
    ...
    execute: async (args) => {
        try {
            ...
            // Add the connection
            const updatedWorkflow = addConnectionToWorkflow(workflow, args.source_node_id, args.source_node_output_name, args.target_node_id, args.target_node_input_name, args.target_node_input_index || 0);
...
export const removeConnectionTool = {
    ...
    execute: async (args) => {
        try {
            ...
            const updatedWorkflow = removeConnectionFromWorkflow(workflow, args.source_node_id, args.source_node_output_name, args.target_node_id, args.target_node_input_name, args.target_node_input_index || 0);
            // Save the updated workflow
            await workflowService.saveWorkflow(updatedWorkflow);
    ...
    execute: async (args) => {
        try {
            ...
            if (args.model_node_id) {
                ...
                if (modelNode) {
                    updatedWorkflow = addConnectionToWorkflow(updatedWorkflow, args.model_node_id, 'main', args.agent_node_id, 'model', 0);
            ...
            if (args.tool_node_ids && args.tool_node_ids.length > 0) {
                for (const toolNodeId of args.tool_node_ids) {
                    ...
                    if (toolNode) {
                        updatedWorkflow = addConnectionToWorkflow(updatedWorkflow, toolNodeId, 'main', args.agent_node_id, 'tools', 0);
            ...
            if (args.memory_node_id) {
                ...
                if (memoryNode) {
                    updatedWorkflow = addConnectionToWorkflow(updatedWorkflow, args.memory_node_id, 'main', args.agent_node_id, 'memory', 0);
            ...
            if (args.embeddings_node_id) {
                ...
                if (embeddingsNode) {
                    updatedWorkflow = addConnectionToWorkflow(updatedWorkflow, args.embeddings_node_id, 'main', args.agent_node_id, 'embeddings', 0);
            ...
            if (args.vector_store_node_id) {
                ...
                if (vectorStoreNode) {
                    updatedWorkflow = addConnectionToWorkflow(updatedWorkflow, args.vector_store_node_id, 'main', args.agent_node_id, 'vectorStore', 0);
